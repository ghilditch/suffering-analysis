...
var Human = function () {
	...
	this.bones = {
		body : new Human.bone( 0,0,0,   10,10,10 ),
		
		LeftUpLeg : new Human.bone(   0,0,0,  15,7,7 ),
		LeftLowLeg : new Human.bone(  0,0,0,      17,7,7 ), 
		RightUpLeg : new Human.bone(  0,0,0,   15,7,7 ),
		RightLowLeg : new Human.bone( 0,0,0,       17,7,7 ),
		
		LeftUpArm : new Human.bone(   0,0,0,      10,5,5 ),
		LeftLowArm : new Human.bone(  0,0,0,      11,5,5   ),
		RightUpArm : new Human.bone(  0,0,0,       10,5,5 ),
		RightLowArm : new Human.bone( 0,0,0,       11,5,5   )
	};
